...
const STikTokLikeTimelineItem = STimelinePluginItem.extend({
...
export const TikTokLikeTimelineItem: TTimelinePluginItemFC<
	z.infer<typeof STikTokLikeTimelineItem>,
	'tiktok-like'
> = (props) => {
	const { item } = props;
...
TikTokLikeTimelineItem.id = 'tiktok-like';
TikTokLikeTimelineItem.schema = STikTokLikeTimelineItem;
