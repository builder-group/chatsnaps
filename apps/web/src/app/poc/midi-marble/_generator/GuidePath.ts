...
import { generate2DPath, type TGenerate2DPathOptions } from './helper';
...
export class GuidePath {
	...
	public visualize(scene: THREE.Scene): void {
		// Visualize points
	...
	public updateNextIndex(position: THREE.Vector2): void {
		while (
...
export type TGuidePathOptions = TGenerate2DPathOptions;
